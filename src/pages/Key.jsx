          ...
          <div className="xl:w-full bg-amber-200 border-b border-gray-300 dark:border-gray-700 py-5">
            ...
            <div className="flex items-center w-11/12 mx-auto">
              <p className="text-md text-gray-800 dark:text-gray-100">
                Ssshhhh... Don't tell this to anyone! Copy it and keep it Safe!
                You will need it for logging in!
              </p>
            </div>
          </div>
          <div className="w-11/12 mx-auto bg-white">
            <div className="container bg-white mx-auto">
              <div className="my-8 text-2xl font-mono font-bold mx-auto xl:w-full xl:mx-0">
                {key}
              </div>
            </div>
          </div>
